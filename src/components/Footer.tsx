  ...
  return (
    <footer className="relative bg-slate-900 text-gray-300 py-16 border-t border-slate-800 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-600 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              <a 
                href="#" 
                className="w-10 h-10 rounded-md bg-slate-800 flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/20"
                aria-label="WhatsApp"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="#" className="text-sm hover:text-white transition-all duration-200 hover:pl-2 inline-block">
                  Tugas Harian
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 group">
                ...
                <div>
                  <div className="text-sm font-medium text-white">Layanan 24/7</div>
                  <div className="text-xs text-gray-400">Selalu online untuk Anda</div>
                </div>
              </li>
              <li className="flex items-start gap-3 group">
